                ...
                {isFinished ? (
                    ...
                    >
                       {gameMode === 'validation' ? (
                            ...
                            <GameResults score={score} total={scorableCardsCount} onReset={handleReset} backLink={backLink} router={router} />
                       )}
                    </motion.div>
                ) : currentCard ? (
                    <motion.div
...
const GameResults = ({ score, total, onReset, backLink, router }: { score: number, total: number, onReset: () => void, backLink: string, router: any }) => {
